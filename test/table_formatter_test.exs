defmodule TableFormatterTest do
  ...
  def split_with_three_columns, do: TableFormatter.split_into_columns(simple_test_data(),headers())
  ...
  test "output is correct" do
    result = capture_io fn ->
      TableFormatter.print_table_for_columns(simple_test_data(), headers())
    end
    assert result == """
       c1 |     c2 |      c4
    ------+--------+--------
