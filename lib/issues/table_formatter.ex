defmodule Issues.TableFormatter do
  ...
  That is, each header identifies a column, and those columns are extracted
  and printed from the rows. We calculate the width of each column to fit the
  ...
  of hyphens, with + signs where the vertical bar between columns goes.
  ...
  and a format string, write the extracted data under the control of the
  format string.
  """
